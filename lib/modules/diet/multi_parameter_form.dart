...
import '../profile/profile_screen.dart'; // ✅ IMPORTANT IMPORT
...
class _MultiParameterFormState extends State<MultiParameterForm> {
  ...
  String food_access = "Self Cooking";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Step ${currentPage + 1} of 14"),
            ...
            child: PageView(
              ...
              children: [
                ...
                buildGradientBackground(buildSingleChoice(
                    ...
                    ["3 Meals","2 Meals", "5 Small Meals", "Intermittent Fasting"],
                    (v) => mealFrequency = v)),
                buildGradientBackground(buildSingleChoice(
                    "Target Timeline",
                ...
                buildGradientBackground(buildMultiChoice(
                    "Allergies",
                    ["Lactose", "Gluten", "Nuts", "Seafood", "None"],
                    allergies)),
                buildGradientBackground(buildMultiChoice(
                    "Medical Conditions",
                    ["Diabetes", "Thyroid", "BP", "PCOS", "None"],
                    medicalConditions)),
              ],
            ),
          ),
 ...
 Widget buildGenderSelection() { 
  return Column( mainAxisAlignment:
   MainAxisAlignment.center, children: [ const Text("Select Gender", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)), const SizedBox(height: 30), Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [ genderCard("Male", Icons.male, Colors.blue), genderCard("Female", Icons.female, Colors.pink), genderCard("Other", Icons.transgender, Colors.purple), ], ) ], ); } Widget genderCard(String value, IconData icon, Color color) { bool isSelected = gender == value; return GestureDetector( onTap: () { setState(() { gender = value; }); }, child: Container( padding: const EdgeInsets.all(20), decoration: BoxDecoration( color: isSelected ? color.withOpacity(0.2) : Colors.white, borderRadius: BorderRadius.circular(15), border: Border.all( color: isSelected ? color : Colors.grey.shade300, width: 2), ), child: Column( children: [ Icon(icon, size: 40, color: color), const SizedBox(height: 10), Text(value, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)), ], ), ), ); }
