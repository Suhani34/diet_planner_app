                ...
                if (currentPage > 0)
                  Expanded(
                    child: OutlinedButton(
                      onPressed:
                          isSubmitting || _isGeneratingPlan ? null : previousPage,
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: (isSubmitting || _isGeneratingPlan)
                          ? null
                          : () async {
                              if (currentPage >= 12) {
    ...
    return AppBackground(
      child: Column(
        children: [
          ...
          ElevatedButton(
            onPressed:
                isSubmitting || _isGeneratingPlan ? null : _handleContinue,
            child: const Text("Generate Locked AI Plan"),
          ),
        ],
      ),
    );
